Still attempting to combine a video selection UI, written in LVGL code, with the AviPlayer from [moononournation](https://github.com/moononournation), written using Arduino_GFX.
